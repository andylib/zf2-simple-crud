...
namespace SimpleCrud\Paginator\View\Helper;
...
class CustomPaginationControl extends AbstractHelper
{
     ...
     * @return string
     */
    public function __invoke(Paginator\Paginator $paginator = null, $params = null)
    {
        $scrollingStyle = null;
        $partial = array('partial/paginator.phtml', 'Service');
        
        if ($paginator === null) {
            if (isset($this->view->paginator)
                and $this->view->paginator !== null
                and $this->view->paginator instanceof Paginator\Paginator) {
